        ...
        _fn : {
            ...
            open_node   : function (obj, callback, skip_animation) {
                ...
                if(!this._is_loaded(obj)) {
                    obj.children("div").children("a").addClass("jstree-loading");
                    ...
                    obj.removeClass("jstree-closed").addClass("jstree-open").children("div").children("a").removeClass("jstree-loading");
            ...
            get_text    : function (obj) {
                ...
                obj = obj.children("div").children("a:eq(0)");
                if(s) {
                    obj = obj.clone();
    ...
    $.jstree.plugin("ui", {
        ...
        _fn : {
            ...
            select_node : function (obj, check, e) {
                ...
                if(check) {
                    if(s.disable_selecting_children && is_multiple &&
                        (
                            (obj.parentsUntil(".jstree","li").children("div").children("a.jstree-clicked").length) ||
                ...
                if(proceed && !is_selected) {
                    ...
                    obj.children("div").addClass("jstree-node-clicked").children("a").addClass("jstree-clicked");
            ...
            get_selected : function (context) {
                return context ? $(context).find("a.jstree-clicked").parent().parent() : this.data.ui.selected;
            },
        ...
        _fn : {
            _show_input : function (obj, callback) {
                ...
                var rtl = this._get_settings().core.rtl,
                    ...
                    w1 = obj.children("div").children("ins").width(),
                    w2 = obj.find("> div > a:visible > ins").width() * obj.find("> div > a:visible > ins").length,
                    t = this.get_text(obj),
                        ...
                        s.data.call(this, obj, $.proxy(function (d) {
                            ...
                            if(!d) {
                                if(obj === -1 || !obj) {
                                    ...
                                    obj.children("div").children("a.jstree-loading").removeClass("jstree-loading");
                                ...
                                else { obj.append(d).children("div").children("a.jstree-loading").removeClass("jstree-loading"); obj.removeData("jstree_is_loading"); }
                                this.clean_node(obj);
                                if(s_call) { s_call.call(this); }
                            }
                        }, this));
                    ...
                    a.each(function () {
                        ...
                        if(
                            ...
                            if(t.children("ins").get(0).style.backgroundImage.length) {
                                /* alt-images tmp2.icon = t.children("ins").get(0).style.backgroundImage.replace("url(","").replace(")",""); */
                            }
                        }
                        else {
...
(function ($) {
        ...
        __init : function () {
            ...
            this.get_container()
                ...
                .delegate("a", "mousemove.jstree", $.proxy(function (e) {
                        if($.vakata.dnd.is_drag && $.vakata.dnd.user_data.jstree) {
                            if(!r || !r.length || r.children("div").children("a")[0] !== e.currentTarget) {
                                this.dnd_enter(e.currentTarget);
                            }
    ...
    $(function() {
        var css_string = '' +
            '#vakata-dragged {background-color:#6498db; visibility:visible; display:block;}' +
...
(function ($) {
    $.vakata.context = {
        ...
        show    : function (s, t, x, y, d, p, rtl) {
            ...
            if(x + w > $(document).width()) {
                ...
                $.vakata.context.cnt.find("li > div > ul").addClass("right");
            }
            if(y + h > $(document).height()) {
                y = y - (h + t[0].offsetHeight);
                $.vakata.context.cnt.find("li > div > ul").addClass("bottom");
            }
        ...
        parse   : function (s, is_callback) {
            ...
            $.each(s, function (i, val) {
                ...
                if(val.icon && val.icon.indexOf("/") !== -1) { /* alt-images str += " style='background:url(" + val.icon + ") center center no-repeat;' "; */ }
    ...
    $.jstree.plugin("contextmenu", {
        __init : function () {
            this.get_container()
                .delegate("div", "contextmenu.jstree", $.proxy(function (e) {
                        e.preventDefault();
        ...
        _fn : {
            show_contextmenu : function (obj, x, y) {
                ...
                var s = this.get_settings().contextmenu,
                    a = obj.children("div").children("a:visible:eq(0)"),
                    o = false,
                    i = false;
